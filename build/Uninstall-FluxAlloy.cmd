...
title FluxAlloy — удаление (распакованная копия)

set "ROOT=%~dp0"
if "%ROOT:~-1%"=="\" set "ROOT=%ROOT:~0,-1%"

echo.
echo FluxAlloy: удаление из папки:
echo   %ROOT%
echo.
...
for %%F in ("%ROOT%\FluxAlloy.exe" "%ROOT%\Uninstall FluxAlloy.cmd" "%ROOT%\Uninstall-FluxAlloy.cmd") do (
