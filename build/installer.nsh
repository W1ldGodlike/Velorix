...
!macro customInstall
  ...
  ExecWait '"$INSTDIR\${APP_EXECUTABLE_FILENAME}" --fluxalloy-install-register-explorer-menu' $0
  ExecWait '"$INSTDIR\${APP_EXECUTABLE_FILENAME}" --fluxalloy-install-register-open-with' $0
!macroend

!macro customUnInstall
  ExecWait '"$INSTDIR\${APP_EXECUTABLE_FILENAME}" --fluxalloy-install-unregister-explorer-menu' $0
  ExecWait '"$INSTDIR\${APP_EXECUTABLE_FILENAME}" --fluxalloy-install-unregister-open-with' $0
