...
| 4         | [`.cursor/skills/velorix-continue/`](../.cursor/skills/velorix-continue/SKILL.md) + [`velorix-agent.mdc`](../.cursor/rules/velorix-agent.mdc) | «продолжай» / `+`: текущая задача или спринт; **Git по J-NNN** — глоссарий + **следующий commit/push по J** в `velorix-agent.mdc` (**J-1580**).                                                                                                            |
...
| Продолжай / + | [`.cursor/skills/velorix-continue/SKILL.md`](../.cursor/skills/velorix-continue/SKILL.md), `velorix-agent.mdc`, `velorix-rules-explicit.mdc`, `continue.txt`, `initial.txt`, `agent-contract.txt` |
