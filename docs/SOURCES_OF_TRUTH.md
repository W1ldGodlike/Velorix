...
| UI-поверхности / copy / Help                  | `fluxalloy-agent.mdc`, `check-ui-surfaces-guard.mjs`, `knowledge-toc-registry.ts`, `check:ui-copy-quality`, `check:help-packaged-smoke-docs`, `check:help-owner-smoke-docs`, чеклист §6/§15 |
...
| Packaged smoke parity (§3/§19)                | `packaged-manual-smoke-step-ids.ts`, `check:packaged-manual-smoke-parity`, `packaged-manual-smoke-plain-text.ts`, `owner-manual-smoke-packaged-section`                                                                  |
...
| Packaged e2e scenarios (§21)                  | `packaged-e2e-smoke-registry.ts`, `packaged-e2e-smoke-scenarios.ts`, `check:packaged-e2e-scenarios-registry`, `packaged-manual-smoke-step-ids.ts`                                                                       |
