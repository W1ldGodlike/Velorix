...
| UI-поверхности / copy / Help                  | `fluxalloy-agent.mdc`, `check-ui-surfaces-guard.mjs`, `knowledge-toc-registry.ts`, `check:ui-copy-quality`, `check:help-packaged-smoke-docs`, чеклист §6/§15                             |
