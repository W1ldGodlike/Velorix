...
| Полный аудит/рефактор репо (временно) | `docs/PROJECT_WIDE_AUDIT_REFACTOR_PLAN.md`, `fluxalloy-project-audit.mdc`, `scripts/audit-scope.config.mjs`, `audit:inventory` / `audit:copy-paste` / `audit:structural` |
