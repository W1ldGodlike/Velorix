...
1. [`IMPLEMENTATION_CHECKLIST.md`](../IMPLEMENTATION_CHECKLIST.md) → **`## Ближайший TODO спринта`**. ТЗ — один § [`FLUXALLOY_TZ.md`](../FLUXALLOY_TZ.md).
...
**Запрещено** новые HTML-pop-out и параллельные UI-словари вне `ui-text` / `locales/**` (`fluxalloy-ui-surfaces.mdc`).
