...
- Packaged smoke after build — [packaged-windows-smoke.md](../packaged-windows-smoke.md) (Linux/macOS — sibling articles); §21 e2e **§21 packaged e2e (CI vs owner)** (`appendPackagedManualSmokeE2eAppendixLines`, per-step `e2e <id>:`) in `releaseSmoke:`; Support ZIP also includes `terminalHints:` (§8) — [about-support-logs.md](about-support-logs.md), [logging-and-diagnostics.md](logging-and-diagnostics.md); Help: `check:help-workflow-smoke-crosslinks` (44 articles; partition: tail 42 + ffmpeg + knowledge, FAQ outside 44).
