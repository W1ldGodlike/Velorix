...
1. **Settings → Dependencies** — **Owner manual smoke** block and **Copy full bundle** (HiDPI + HW + scenario builder + OS scheduler + Windows shell + dpi snapshot).
2. Below that: separate panels for **NVENC/VAAPI**, **HiDPI** (General tab), **packaged smoke**, **Windows Explorer**, and OS scheduler steps in the **task planner**.
