...
Support ZIP **`terminalHints:`** in `diagnostics.txt` (dev guards, not runtime) — `npm run check:support-bundle-terminal-hints`; see [logging-and-diagnostics.md](logging-and-diagnostics.md), [about-support-logs.md](about-support-logs.md).
