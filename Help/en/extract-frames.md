...
See [editor-workflow.md](editor-workflow.md). Packaged smoke **snapshot** / §7.5 sprite steps — [packaged-windows-smoke.md](../packaged-windows-smoke.md), [owner-manual-smoke.md](owner-manual-smoke.md); §21 e2e per-step `e2e <id>:` in `releaseSmoke:`.
