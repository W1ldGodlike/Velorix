...
See also [workflows-planner-scenarios.md](workflows-planner-scenarios.md), [getting-started.md](getting-started.md). Owner manual **Windows shell** checklist in Support ZIP — [owner-manual-smoke.md](owner-manual-smoke.md) (`ownerManualSmoke:`; §21 e2e per-step `e2e <id>:` in `releaseSmoke:`); dev block `terminalHints:` (§8, 24 articles) — [logging-and-diagnostics.md](logging-and-diagnostics.md); packaged open-file — [packaged-windows-smoke.md](../packaged-windows-smoke.md).
