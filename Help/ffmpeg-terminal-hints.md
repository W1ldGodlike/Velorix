...
Support ZIP **`terminalHints:`** в `diagnostics.txt` (dev guards, не runtime) — `npm run check:support-bundle-terminal-hints`; см. [logging-and-diagnostics.md](logging-and-diagnostics.md), [about-support-logs.md](about-support-logs.md).
