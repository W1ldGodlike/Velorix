...
- **`ownerManualSmoke:`** — единый пакет владельца (тема, HiDPI, HW, сценарий, спрайт §7.5, мини-плеер §4.3, packaged для вашей ОС, планировщик, Windows shell); канон **ru**, см. [owner-manual-smoke.md](owner-manual-smoke.md) и копирование в **Настройки → ручной проверки** (при EN UI в буфере — EN-строки из locales).
