...
| Блок             | Смысл                                                                                        |
| ---------------- | -------------------------------------------------------------------------------------------- |
| Theme            | Единый VELORIX NEON UI: контраст, focus, modals, surfaces загрузок/инспектора, отсутствие legacy theme/pop-out UX |
