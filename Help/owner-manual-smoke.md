...
1. **Настройки → Зависимости** — блок **«Ручной smoke (владелец)»**: разверните превью секций (HiDPI, HW, сценарий, packaged, планировщик, shell), затем **«Скопировать весь пакет»** (тот же текст в Support ZIP `ownerManualSmoke:`). Кнопки **«К …»** переключают вкладку настроек и прокручивают к панели HW, packaged, HiDPI или Проводнику.
