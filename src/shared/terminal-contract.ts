...
export const TERMINAL_SCENARIO_HINTS_DOWNLOADS: TerminalCommandHintEntry[] = [
  ...
  {
    tool: 'yt-dlp',
    token: '· разрешить локальные file-URL -F',
  ...
  {
    tool: 'yt-dlp',
    token: '· в файл: схема URL страницы',
  ...
  {
    tool: 'yt-dlp',
    token: '· в файл: URL страницы плейлиста',
  ...
  {
    tool: 'yt-dlp',
    token: '· в файл: URL канала плейлиста',
