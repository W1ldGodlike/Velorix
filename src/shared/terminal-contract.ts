...
export const TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA: TerminalCommandHintEntry[] = [
  ...
  {
    tool: 'ffprobe',
    token: '· видео v:0 profile и level',
  ...
  {
    tool: 'ffprobe',
    token: '· субтитры s:0 PTS и таймбаза',
  ...
  {
    tool: 'ffprobe',
    token: '· теги WMFSDKVersion / encoder',
