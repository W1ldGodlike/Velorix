...
export const TERMINAL_SCENARIO_HINTS_DOWNLOADS: TerminalCommandHintEntry[] = [
  ...
  {
    tool: 'yt-dlp',
    token: '· постправка контейнера: warn -F',
...
export const TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA: TerminalCommandHintEntry[] = [
  ...
  {
    tool: 'ffprobe',
    token: '· теги контейнера (title, encoder)',
  ...
  {
    tool: 'ffprobe',
    token: '· контейнер: start_time и duration',
  ...
  {
    tool: 'ffprobe',
    token: '· субтитры s:0 disposition',
  ...
  {
    tool: 'ffprobe',
    token: '· контейнер: brands (MP4/MOV)',
  ...
  {
    tool: 'ffprobe',
    token: '· видео v:0 chroma_location',
  ...
  {
    tool: 'ffprobe',
    token: '· видео v:0 avg_frame_rate',
  ...
  {
    tool: 'ffprobe',
    token: '· видео v:0 codec_long_name',
  ...
  },
  {
    ...
    summary: 'Вторая видеодорожка v:2: кодек, размеры, профиль и уровень (codec_name, width, height, profile, level; мультиракурс и редкие контейнеры); путь к медиа подставляется из превью.',
