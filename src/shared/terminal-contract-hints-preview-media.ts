...
import { TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_09 } from './terminal-contract-hints-preview-media-09'
import { TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_10 } from './terminal-contract-hints-preview-media-10'
import { TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_11 } from './terminal-contract-hints-preview-media-11'
import { TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_12 } from './terminal-contract-hints-preview-media-12'
import { TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_13 } from './terminal-contract-hints-preview-media-13'
import { TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_14 } from './terminal-contract-hints-preview-media-14'
import { TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_15 } from './terminal-contract-hints-preview-media-15'
...
export const TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA = [
  ...
  ...TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_09,
  ...TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_10,
  ...TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_11,
  ...TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_12,
  ...TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_13,
  ...TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_14,
  ...TERMINAL_SCENARIO_HINTS_PREVIEW_MEDIA_PART_15
] as const
