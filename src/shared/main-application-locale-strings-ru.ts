...
export const mainApplicationStringsRu: MainApplicationStrings = {
  ...
  presetsParseErrorMessage: 'Ожидается JSON пресета или пакет fluxalloy.export-presets-bundle.v1.',
  ...
  quitConfirmIdle: 'Закрыть FluxAlloy?',
  quitConfirmIdleWithQueue: 'Закрыть FluxAlloy? В очереди загрузок ожидает {n} заданий.',
  quitStay: 'Остаться',
