...
export const mainApplicationStringsEn: MainApplicationStrings = {
  ...
  settingsBackupExportTitle: 'Export FluxAlloy settings',
  settingsBackupExportFilter: 'Settings JSON',
  settingsBackupImportTitle: 'Import FluxAlloy settings',
  ...
  settingsBackupParseErrorMessage: 'Expected a FluxAlloy export JSON or a settings.json fragment.',
  ...
  presetsParseErrorMessage:
    'Expected a preset JSON file or fluxalloy.export-presets-bundle.v1 bundle.',
  ...
  quitConfirmIdle: 'Close FluxAlloy?',
  quitConfirmIdleWithQueue: 'Close FluxAlloy? {n} download(s) are waiting in the queue.',
  quitStay: 'Stay',
