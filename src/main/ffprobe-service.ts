...
export async function probeMediaFile(
  ...
  return {
    ...
    containerPublisherTag: parseFfprobeFormatPublisherTag(parsed.format?.tags),
    containerEncodedByTag: parseFfprobeFormatEncodedByTag(parsed.format?.tags),
    containerSoftwareTag: parseFfprobeFormatSoftwareTag(parsed.format?.tags),
    containerTitleTag: parseFfprobeFormatTitleTag(parsed.format?.tags),
    containerCommentTag: parseFfprobeFormatCommentTag(parsed.format?.tags),
    containerSynopsisTag: parseFfprobeFormatSynopsisTag(parsed.format?.tags),
    containerDescriptionTag: parseFfprobeFormatDescriptionTag(parsed.format?.tags),
    containerKeywordsTag: parseFfprobeFormatKeywordsTag(parsed.format?.tags),
    containerLyricsTag: parseFfprobeFormatLyricsTag(parsed.format?.tags),
    containerArtistTag: parseFfprobeFormatArtistTag(parsed.format?.tags),
    containerPerformerTag: parseFfprobeFormatPerformerTag(parsed.format?.tags),
    containerSortArtistTag: parseFfprobeFormatSortArtistTag(parsed.format?.tags),
    containerAlbumTag: parseFfprobeFormatAlbumTag(parsed.format?.tags),
    containerAlbumArtistTag: parseFfprobeFormatAlbumArtistTag(parsed.format?.tags),
    containerSortAlbumTag: parseFfprobeFormatSortAlbumTag(parsed.format?.tags),
    containerSortTitleTag: parseFfprobeFormatSortTitleTag(parsed.format?.tags),
    containerGenreTag: parseFfprobeFormatGenreTag(parsed.format?.tags),
    containerTrackTag: parseFfprobeFormatTrackTag(parsed.format?.tags),
    containerDiscTag: parseFfprobeFormatDiscTag(parsed.format?.tags),
    containerCopyrightTag: parseFfprobeFormatCopyrightTag(parsed.format?.tags),
    containerIsrcTag: parseFfprobeFormatIsrcTag(parsed.format?.tags),
    containerDateTag: parseFfprobeFormatDateTag(parsed.format?.tags),
    containerLocationTag: parseFfprobeFormatLocationTag(parsed.format?.tags),
    containerPurchaseDateTag: parseFfprobeFormatPurchaseDateTag(parsed.format?.tags),
