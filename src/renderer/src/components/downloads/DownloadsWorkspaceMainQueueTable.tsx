  ...
  return (
    ...
    >
      <table
        ...
        aria-busy={downloadsOptionsBusy || downloadsHistoryBusy}
      >
        <caption className="app-visually-hidden">{uiText('downloadsQueueTableCaption')}</caption>
        <thead>
          <tr>
            ...
            visibleDownloadsRows.map((row) => {
              ...
              return (
                <tr key={row.id}>
                  ...
                  <td className="app-downloads-mono" headers={DOWNLOADS_QUEUE_TABLE_HEADER_IDS.eta}>
