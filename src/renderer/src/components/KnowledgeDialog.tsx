...
export function KnowledgeDialog({
  ...
  const renderKnowledgeChrome = (embedded: boolean): JSX.Element => (
    <div
      className={
        embedded
          ? 'app-knowledge-dialog app-knowledge-dialog-embedded'
          : 'app-modal app-modal-wide app-knowledge-dialog'
      }
  ...
  if (presentation === 'embedded') {
    return renderKnowledgeChrome(true)
  }
