...
export function WorkflowScenarioBuilderDialog(
  ...
  const renderScenarioChrome = (embedded: boolean): JSX.Element => (
    <div
      className={
        embedded
          ? 'workflow-scenario-builder-dialog workflow-scenario-builder-dialog-embedded'
          : 'app-modal app-modal-wide workflow-scenario-builder-dialog'
      }
  ...
  if (presentation === 'embedded') {
    return renderScenarioChrome(true)
  }
