...
/** Парсит «N test files / M tests» из snap.17 и AGENTS.md. */
...
describe('AGENTS.md ↔ IMPLEMENTATION_CHECKLIST snap.17', () => {
  it('test file and test counts match between AGENTS and checklist', () => {
