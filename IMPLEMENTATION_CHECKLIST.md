...
- [~] §9: инспектор — отдельное окно §363; при необходимости доп. поля ffprobe (пикс. формат, SAR…).
...
- [x] Таблица дорожек под превью (`tags`, битрейт/`disposition` дорожки, контекстное меню; отдельное окно — §363).
