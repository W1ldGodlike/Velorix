...
- [~] §1.1/§4.A/§9: редактор/инспектор/ffprobe хорошо продвинуты; binary controls уже через общий `PillSwitch`; дальше — multi-monitor DPI, help links, локализация строк и редкие ffprobe-поля.
