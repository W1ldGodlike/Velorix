...
- [~] §6.1/§6.4: yt-dlp — очередь, лог, история, авто-preview, профили повтора, маркеры stderr + классификация transient/source, пауза SIGSTOP/SIGCONT; дальше вывод классификации в UI/статусе и парсинг прогресса (редкие форматы строк).
