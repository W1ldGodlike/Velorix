...
- [~] §1.1/§4.A/§6: UI — v0-подход начат: тёмная монтажная палитра, компактный topbar, вкладки Editor/Downloads, FFmpeg-настройки в правой панели; окно загрузок переведено на table/log/right-settings layout; дальше — единые иконки и сохранение раскрытых секций.
