...
- [~] §6.1/§6.4: вкладка «Загрузки» v0 — таблица / rail / история→лог; **прогресс: полоска + `%` справа**; оба primary CTA; **полоса действий: `clipboard` + `popOutWindow` из shared**; HiDPI **120 / 168 / 192**; **узкая ширина (`≤1100px`): rail под колонкой**; **осталось: ручная DPI-матрица 100–200%**.
