...
- [~] §7.2/§20: системные пресеты libx264, persisted контейнер/формат, CRF и AAC bitrate есть; дальше пользовательские пресеты и расширенные параметры кодирования.
