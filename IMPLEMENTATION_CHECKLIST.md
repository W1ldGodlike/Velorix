...
- [~] §9/§18: ffprobe/диагностика — inspector, TXT/HTML/JSON export, logs, Support ZIP есть; в сводке дорожки — расширенные видео-поля ffprobe (профиль/уровень/field_order/chroma/bits, при отличии — coded size, `refs`, B-кадры, FourCC `codec_tag_string`); дальше — rotation/displaymatrix/SAR в detail, crash/e2e smoke, расширение диагностического отчёта.
