...
- [~] §6.1/§6.4: yt-dlp — очередь, лог, история, авто-preview, профили повтора, маркеры stderr + классификация + стабильные коды 2/100/101, пауза SIGSTOP/SIGCONT; дальше парсинг прогресса (редкие форматы строк) и доп. коды при появлении в апстриме.
