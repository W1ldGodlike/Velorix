...
- [~] §6.1/§6.2: менеджер yt-dlp — очередь, прогресс stdout/stderr, каталог, cookies, impersonate, лимит скорости/ретраи; дальше история/обработка ошибок и retry-профили.
