...
- [~] §6.1/§6.4: вкладка «Загрузки» v0 — таблица / rail / история→лог; **прогресс: полоска + `%` справа**; оба primary CTA; HiDPI **120 / 168 / 192**; **узкая ширина (`≤1100px`): rail под основной колонкой** с `max-height`+scroll, не `display:none`; **осталось: ручная DPI-матрица 100–200%**.
