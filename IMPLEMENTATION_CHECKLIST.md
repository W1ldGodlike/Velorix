...
- [~] Аудио кодек: AAC, **PCM s16le**, **Opus (libopus, MKV-only)**, **FLAC (MKV-only)** или без аудио; **громкость аудио** через `-filter:a volume=NdB` (`ffmpegExportAudioGainDb`, шаг 3 дБ, диапазон −24…+24); выбор другого кодека — позже.
