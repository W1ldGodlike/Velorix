...
- [~] §1.1/§4.A/§6: UI — окно загрузок: `lucide-downloads-icons.ts` синхронизирует топбар React и очередь; cluster film/home/settings/help + IPC-мост в главное окно §4.A; нижние `details` (история/журнал/подсказки) — ▸ как FFmpeg-панель; дальше — палитра/focus-токены и полировка инспектора §9.
