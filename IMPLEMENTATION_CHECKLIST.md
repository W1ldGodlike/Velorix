...
- [~] §6.1/§6.4: yt-dlp workspace почти основной: очередь/лог/история/retry/pause/settings/catalog/cookies/network встроены; snapshot очереди рассылается во вкладку и pop-out; дальше — редкие settings, редкие шаблоны логов и ручная DPI-матрица.
