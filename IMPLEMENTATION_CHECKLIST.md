...
- [~] §9: инспектор под превью — расширить таблицу дорожек (доп. колонки); отдельное окно позже.
...
- [~] Таблица дорожек (базовая под превью + контекстное меню копирования; расширенные колонки и отдельное окно позже).
