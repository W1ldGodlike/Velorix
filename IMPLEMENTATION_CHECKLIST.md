...
- [~] §19/§3/§17: release/security hardening — CI (кэш `bin/`, prepare, verify, build, `pack:dir`), `check:release`, `engines:report-hashes`, NSIS+portable+zip; дальше — ручной smoke полных артефактов, exe-хеши в JSON, подпись.
