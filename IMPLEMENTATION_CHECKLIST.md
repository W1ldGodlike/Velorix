...
- [~] §1.1/§4.A: UI — v0-подход начат: тёмная монтажная палитра, компактный topbar, вкладки Editor/Downloads, FFmpeg-настройки в правой сворачиваемой панели; дальше — довести окно загрузок и единые иконки.
...
- [~] Довести палитру, типографику, отступы, радиусы и focus-состояния на всех экранах: главный renderer начат, downloads/inspector ещё требуют полировки.
