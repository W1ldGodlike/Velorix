...
- [~] §6.3: argv + whitelist + preview; pop-out **узкий ≤960px**: rail **под** очередью + scroll + **«К настройкам»** (`#dl-ytdlp-settings-rail`); **справочник токенов**: поиск + кликабельный список; редкие поля.
