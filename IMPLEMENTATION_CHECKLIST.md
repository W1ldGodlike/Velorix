...
- [~] §6.1/§6.2/§6.4: менеджер yt-dlp — очередь, прогресс, каталог, cookies, impersonate, лимит/`--retries`, профили повтора, история + фильтр/повтор URL; дальше fragment-retries и обработка ошибок.
