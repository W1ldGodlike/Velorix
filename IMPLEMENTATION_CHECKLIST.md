...
- [~] §21: e2e registry/guards [x] (44+6+8; tail 42 + ffmpeg `FfmpegTerminalWorkflowClause` + knowledge; FAQ вне 44); GUI Playwright — позже.
