...
- [~] Сводка ошибок после завершения; **drag-reorder**; economy/history/open; **retry failed** + **clear completed** + retry строки.

### §7.4 Комбинированный режим

- [ ] URL на обработке отправляется в yt-dlp или разовый сценарий по настройке.
- [~] Скачанный файл можно вручную отправить как источник из очереди/истории yt-dlp; **добавление готовых загрузок и истории в пакетный экспорт**; автоцепочка — позже.
