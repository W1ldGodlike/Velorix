...
- [~] §1.1/§4.A/§6/§9: загрузки lucide/layout/тема/HiDPI; инспектор — lucide-тулбар; редактор — главный topbar ближе к v0 по высоте, **persist** сворачивания «Превью команды ffmpeg» (`exportCommandPreview`); дальше — системная тема OS, DPI 100–200%, полировка инспектора.
