...
- [~] §19: `pack:*:dir` + `verify:*`; bin/Help `engines:doctor`/`prepare:win`; Help crosslinks guard 28; CI linux [x]; приёмка packaged на железе — владелец.
