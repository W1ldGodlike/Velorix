...
4. [~] Главное окно обработки: файл/DnD, таймлайн (scrub + in/out в UI), ffprobe-сводка; экспорт/ffmpeg-пайплайн — дальше.
...
- [~] Таймлайн: базовый scrub + маркеры in/out в UI; привязка к ffmpeg trim при экспорте — позже.
- [x] Маркеры in/out.
