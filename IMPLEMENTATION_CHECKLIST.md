...
- [~] §6.1/§6.4: вкладка «Загрузки» v0 — таблица / rail / **история→лог** (иконки **refresh/trash/file/folder/outbound/save/x** на compact-кнопках); **rail «Метаданные/Сохранение» + футер** — `app-btn-icon-leading` (**file/x**, **folder/plus/home**, **refresh/ban**); **прогресс: bar+%**; **URL-band**; HiDPI **120/168/192**; узкая ширина + **«К настройкам»**; **осталось: ручная DPI-матрица 100–200%**.
