...
- [~] §6.1/§6.4: downloads core — очередь, история, лог, retry, pause, output resolving, preview proxy и React-вкладка есть; редкие retry/fixup строки yt-dlp частично закрыты; дальше — сценарий download→encode и уменьшение дубляжа embedded/pop-out.
