...
- [~] IntelliSense в строке argv (v1): до 14 подсказок из merge JSON+сценариев, Tab/Enter/↑↓/Shift+Tab/Home/End/PgUp/PgDn (шаг 5), Escape, навигация при сужении списка (clamp stale-индекса), `shared/terminal-inline-suggest` + Vitest.
...
- [~] Viewer внутри приложения (markdown body: blockquote/`>`, внутренние `.md` и внешние `https`).
- [x] Оглавление.
- [x] Поиск.
