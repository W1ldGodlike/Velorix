...
- [~] §1.1/§4.A/§6/§9: загрузки lucide/layout/тема/HiDPI; live-панели; инспектор `app-topbar`/`probe*`; rail pill; **очередь** — прогресс bar+%, зебра/hover; дальше — DPI-матрица 100–200%, ffprobe, журнал операций §6.4.
