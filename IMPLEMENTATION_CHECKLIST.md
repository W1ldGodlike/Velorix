...
- [~] Главное окно существует и уже сфокусировано на preview/ffmpeg обработке; toolbar переносит элементы без горизонтального расползания, часть глобальных кнопок ещё требует финальной компоновки.
