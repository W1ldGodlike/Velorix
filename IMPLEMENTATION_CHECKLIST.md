...
- [~] §9: инспектор — отдельное окно позже; при необходимости ещё колонки ffprobe ( disposition и т.п.).
...
- [x] Таблица дорожек под превью (колонки язык/заголовок из `tags`, контекстное меню; отдельное окно — §363).
