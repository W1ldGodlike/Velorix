...
- [~] §7: превью + таймлайн (seek, In/Out) + экспорт MP4 + расширенный ffprobe под превью (дорожки, JSON); отдельное окно инспектора §9 — позже.
...
5. [~] Окно менеджера yt-dlp: очередь + последовательный spawn; лог stdout/stderr §6.4 в окне; парсинг скорости/ETA и сохранение лога — дальше.
