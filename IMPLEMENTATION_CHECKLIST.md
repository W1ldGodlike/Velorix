...
- [~] §9/§18: ffprobe/диагностика — inspector, TXT/HTML/JSON export, logs, Support ZIP есть; в сводке дорожки — расширенные видео-поля ffprobe + SAR/DAR (кроме тривиального 1:1), `matrix …°` из Display Matrix или `rot …°` из тега `rotate`; дальше — crash/e2e smoke, расширение диагностического отчёта.
