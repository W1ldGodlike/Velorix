...
const steps = [
  ...
  ['owner-hardware-checklist-locale', ['run', 'check:owner-hardware-checklist-locale']],
  ...
  ['help-owner-hardware-checklist-docs', ['run', 'check:help-owner-hardware-checklist-docs']],
