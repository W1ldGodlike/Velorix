---
name: Velorix-journal-entry
description: Writes IMPLEMENTATION_JOURNAL entries for Velorix. Use when finishing a coding iteration with repository diff, journal stamp, J-NNN format, Assistant vs SDK tags, check journal.
---

# Запись в журнал (VELORIX)
