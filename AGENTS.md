...
**Git по J-NNN:** `NNN % 5` → commit, `NNN % 10` → push (любой чат); **следующий commit по J** **J-1720**, **следующий push по J** **J-1720** — [`velorix-agent.mdc`](.cursor/rules/velorix-agent.mdc).
